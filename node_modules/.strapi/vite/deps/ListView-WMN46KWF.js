...
var DynamicZoneList = ({ components = [], addComponent, name, forTarget, targetUid, disabled = false }) => {
  ...
  const [activeTab, setActiveTab] = (0, import_react5.useState)(0);
  const { formatMessage } = useIntl();
  const toggle = (tab) => {
    if (activeTab !== tab) {
      setActiveTab(tab);
    ...
    children: (0, import_jsx_runtime6.jsxs)(Box, {
      children: [
        (0, import_jsx_runtime6.jsx)(Box, {
          padding: 2,
          paddingLeft: "104px",
          children: (0, import_jsx_runtime6.jsxs)(ScrollableStack, {
            gap: 2,
            children: [
...
`;
var AttributeRow = (0, import_react6.forwardRef)((props, ref) => {
...
var MemoizedRow = (0, import_react6.memo)((props) => {
...
var List = ({ addComponentToDZ, firstLoopComponentUid, isFromDynamicZone = false, isMain = false, isSub = false, secondLoopComponentUid, type }) => {
  ...
  const [activeId, setActiveId] = (0, import_react7.useState)(null);
  ...
  return (0, import_jsx_runtime9.jsxs)(DndContext, {
    ...
    children: [
      (0, import_jsx_runtime9.jsxs)(ListGrid, {
        tag: "ul",
        children: [
          (0, import_react_dom2.createPortal)((0, import_jsx_runtime9.jsx)(DragOverlay, {
            zIndex: 10,
...
var StyledButton = dt(Button)`
  white-space: nowrap;
`;
var LinkToCMSettingsView = (0, import_react8.memo)(({ disabled, type }) => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=ListView-WMN46KWF.js.map
